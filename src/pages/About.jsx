...
function About() {
    return (
        ...
        >
            ...
            >
                <div className="max-w-xlg lg:mb-16 md:w-3/5 md:mr-12 order-2 md:order-1">
                    <h1
                        className="font-mono text-3xl md:text-4xl lg:text-4xl font-bold mb-4 sm:mt-16 md:mt-8 mx-10"
                        style={{ color: '#D24FB3ff' }}
                    >
                        Front-End & UX/UI minded with Full Stack tendencies
                    </h1>
                    <br />
                    <p className="font-mono text-base md:text-lg text-white leading-relaxed mb-8 mx-8 flex justify-center">
                ...
                <div className="max-w-md md:ml-12 mt-4 md:mt-0 md:mb-0 order-1 md:order-2 sm:w-3/4 md:w-1/2 lg:w-3/4 mx-auto flex justify-center">
                    <img
                        src="/Me.jpg"
                        alt="Self portrait"
